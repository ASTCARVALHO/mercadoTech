...
public class TestaSistemaAmigo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            sistemaAmigo.enviarMensagemParaAlguem("E agora José?", "maria@gmail.com", "jose@gmail.com", true);
            sistemaAmigo.enviarMensagemParaAlguem("Tá cheia de graça, hein?", "jose@gmail.com", "maria@gmail.com", true);
